...
namespace PHPSTORM_META {
    ...
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
        'App\Contracts\BookApiServiceInterface' => \App\Services\GoogleBooksService::class,
    ...
    registerArgumentsSet('configs',
        ...
        'filesystems.disks.s3.endpoint', 'filesystems.disks.s3.use_path_style_endpoint', 'filesystems.disks.s3.throw', 'filesystems.disks.s3.report', 'filesystems.disks.enum-js.driver',
        'filesystems.disks.enum-js.root', 'filesystems.links./Users/mason/Sites/library/public/storage', 'image-transform.public_path', 'image-transform.route_prefix', 'image-transform.enabled_options',
        'image-transform.cache.enabled', 'image-transform.cache.lifetime', 'image-transform.cache.disk', 'image-transform.rate_limit.enabled', 'image-transform.rate_limit.disabled_for_environments',
        'image-transform.rate_limit.max_attempts', 'image-transform.rate_limit.decay_seconds', 'image-transform.headers.Cache-Control', 'inertia.ssr.enabled', 'inertia.ssr.url',
        ...
        'mail.markdown.paths', 'model_settings.settings_field_name', 'model_settings.settings_table_name', 'model_settings.settings_persistent', 'model_settings.settings_table_use_cache',
        'model_settings.settings_table_cache_prefix', 'model_settings.defaultSettings.users', 'queue.default', 'queue.connections.sync.driver', 'queue.connections.database.driver',
        ...
        'solo.keybindings.vim', 'solo.commands.Vite', 'solo.commands.Queue', 'solo.commands.Logs', 'solo.commands.Tests',
        'solo.commands.Nightwatch', 'solo.use_screen', 'solo.dump_server_host', 'ziggy.output.path', 'hashing.driver',
        ...
        'horizon.environments.production.supervisor-1.balanceCooldown', 'horizon.environments.local.supervisor-1.maxProcesses', 'nightwatch.enabled', 'nightwatch.token', 'nightwatch.deployment',
        'nightwatch.server', 'nightwatch.sampling.requests', 'nightwatch.sampling.commands', 'nightwatch.sampling.exceptions', 'nightwatch.filtering.ignore_cache_events',
        'nightwatch.filtering.ignore_mail', 'nightwatch.filtering.ignore_notifications', 'nightwatch.filtering.ignore_outgoing_requests', 'nightwatch.filtering.ignore_queries', 'nightwatch.ingest.uri',
        ...
        'livewire.pagination_theme', 'media-library.disk_name', 'media-library.max_file_size', 'media-library.queue_connection_name', 'media-library.queue_name',
    ...
    registerArgumentsSet('routes',
        ...
        'api.books.search', 'api.books.test', 'api.books.fetch_by_identifier', 'api.books.fetch_or_create', 'api.user.settings.single.update', 'image.transform', 'cover.update', 'cover.destroy',
    ...
    registerArgumentsSet('translations',
        ...
        'filament-tables::table.column_manager.heading', 'filament-tables::table.column_manager.actions.apply.label', 'filament-tables::table.columns.actions.label', 'filament-tables::table.columns.text.actions.collapse_list', 'filament-tables::table.columns.text.actions.expand_list',
        ...
        'filament-tables::table.actions.enable_reordering.label', 'filament-tables::table.actions.filter.label', 'filament-tables::table.actions.group.label', 'filament-tables::table.actions.open_bulk_actions.label', 'filament-tables::table.actions.column_manager.label',
        ...
        'filament-tables::table.filters.select.placeholder', 'filament-tables::table.filters.select.relationship.empty_option_label', 'filament-tables::table.filters.trashed.label', 'filament-tables::table.filters.trashed.only_trashed', 'filament-tables::table.filters.trashed.with_trashed',
    ...
    registerArgumentsSet('env',
        ...
        'APP_LOCALE', 'APP_FALLBACK_LOCALE', 'APP_FAKER_LOCALE', 'APP_MAINTENANCE_DRIVER', 'NIGHTWATCH_TOKEN',
        'NIGHTWATCH_REQUEST_SAMPLE_RATE', 'NIGHTWATCH_IGNORE_CACHE_EVENTS', 'PHP_CLI_SERVER_WORKERS', 'BCRYPT_ROUNDS', 'LOG_CHANNEL',
        ...
        'AWS_USE_PATH_STYLE_ENDPOINT', 'VITE_APP_NAME', 'DUSK_HEADLESS_DISABLED', );
