...
namespace PHPSTORM_META {
    ...
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
        'App\Contracts\BookApiServiceInterface' => \App\Services\ISBNdbService::class,
    ...
    override(\config(), map([
        ...
        'filesystems.disks.enum-js.driver' => 'string',
        'filesystems.disks.enum-js.root' => 'string',
        'filesystems.links./Users/mason/Sites/library/public/storage' => 'string',
        'image-transform.public_path' => 'string',
        'image-transform.route_prefix' => 'string',
        'image-transform.enabled_options' => 'array',
        'image-transform.cache.enabled' => 'boolean',
        'image-transform.cache.lifetime' => 'integer',
        'image-transform.cache.disk' => 'string',
        'image-transform.rate_limit.enabled' => 'boolean',
        'image-transform.rate_limit.disabled_for_environments' => 'array',
        'image-transform.rate_limit.max_attempts' => 'integer',
        'image-transform.rate_limit.decay_seconds' => 'integer',
        'image-transform.headers.Cache-Control' => 'string',
        ...
        'model_settings.settings_field_name' => 'string',
        'model_settings.settings_table_name' => 'string',
        'model_settings.settings_persistent' => 'boolean',
        'model_settings.settings_table_use_cache' => 'boolean',
        'model_settings.settings_table_cache_prefix' => 'string',
        'model_settings.defaultSettings.users' => 'array',
        ...
        'seotools.opengraph.defaults.description' => 'NULL',
        ...
        'seotools.twitter.defaults.description' => 'NULL',
        'seotools.json-ld.defaults.title' => 'string',
        'seotools.json-ld.defaults.description' => 'NULL',
        'seotools.json-ld.defaults.url' => 'NULL',
        'seotools.json-ld.defaults.type' => 'string',
        'seotools.json-ld.defaults.images' => 'array',
        'seotools.json-ld.defaults.sameAs' => 'array',
        'seotools.json-ld.publisher.@type' => 'string',
        'seotools.json-ld.publisher.name' => 'string',
        'seotools.json-ld.publisher.description' => 'NULL',
        'seotools.json-ld.publisher.logo.@type' => 'string',
        'seotools.json-ld.publisher.logo.@id' => 'string',
        'seotools.json-ld.publisher.logo.width' => 'integer',
        'seotools.json-ld.publisher.logo.height' => 'integer',
        'seotools.json-ld.publisher.logo.url' => 'string',
        'seotools.json-ld.publisher.logo.contentUrl' => 'string',
        'seotools.json-ld.publisher.logo.caption' => 'string',
        ...
        'solo.commands.Nightwatch' => 'object',
    ...
    registerArgumentsSet('configs',
        ...
        'database.connections.sqlsrv.prefix', 'database.connections.sqlsrv.prefix_indexes', 'database.connections.testing.driver', 'database.connections.testing.url', 'database.connections.testing.database',
        'database.connections.testing.prefix', 'database.connections.testing.foreign_key_constraints', 'database.connections.testing.busy_timeout', 'database.connections.testing.journal_mode', 'database.connections.testing.synchronous',
        ...
        'filesystems.disks.s3.throw', 'filesystems.disks.s3.report', 'filesystems.disks.enum-js.driver', 'filesystems.disks.enum-js.root', 'filesystems.links./Users/mason/Sites/library/public/storage',
        'image-transform.public_path', 'image-transform.route_prefix', 'image-transform.enabled_options', 'image-transform.cache.enabled', 'image-transform.cache.lifetime',
        'image-transform.cache.disk', 'image-transform.rate_limit.enabled', 'image-transform.rate_limit.disabled_for_environments', 'image-transform.rate_limit.max_attempts', 'image-transform.rate_limit.decay_seconds',
        'image-transform.headers.Cache-Control', 'inertia.ssr.enabled', 'inertia.ssr.url', 'inertia.testing.ensure_pages_exist', 'inertia.testing.page_paths',
        ...
        'model_settings.settings_field_name', 'model_settings.settings_table_name', 'model_settings.settings_persistent', 'model_settings.settings_table_use_cache', 'model_settings.settings_table_cache_prefix',
        'model_settings.defaultSettings.users', 'octane.server', 'octane.https', 'octane.listeners.Laravel\\Octane\\Events\\WorkerStarting', 'octane.listeners.Laravel\\Octane\\Events\\RequestReceived',
        ...
        'sanctum.middleware.authenticate_session', 'sanctum.middleware.encrypt_cookies', 'sanctum.middleware.validate_csrf_token', 'seotools.inertia', 'seotools.meta.defaults.title',
        'seotools.meta.defaults.titleBefore', 'seotools.meta.defaults.description', 'seotools.meta.defaults.separator', 'seotools.meta.defaults.keywords', 'seotools.meta.defaults.fb:app_id',
        'seotools.meta.defaults.canonical', 'seotools.meta.defaults.image', 'seotools.meta.webmaster_tags.google', 'seotools.meta.webmaster_tags.bing', 'seotools.meta.webmaster_tags.alexa',
        ...
        'seotools.opengraph.defaults.description', 'seotools.opengraph.defaults.url', 'seotools.opengraph.defaults.type', 'seotools.opengraph.defaults.site_name', 'seotools.twitter.defaults.card',
        'seotools.twitter.defaults.site', 'seotools.twitter.defaults.description', 'seotools.json-ld.defaults.title', 'seotools.json-ld.defaults.description', 'seotools.json-ld.defaults.url',
        'seotools.json-ld.defaults.type', 'seotools.json-ld.defaults.images', 'seotools.json-ld.defaults.sameAs', 'seotools.json-ld.publisher.@type', 'seotools.json-ld.publisher.name',
        'seotools.json-ld.publisher.description', 'seotools.json-ld.publisher.logo.@type', 'seotools.json-ld.publisher.logo.@id', 'seotools.json-ld.publisher.logo.width', 'seotools.json-ld.publisher.logo.height',
        'seotools.json-ld.publisher.logo.url', 'seotools.json-ld.publisher.logo.contentUrl', 'seotools.json-ld.publisher.logo.caption', 'services.postmark.token', 'services.resend.key',
        ...
        'services.isbndb.key', 'session.driver', 'session.lifetime', 'session.expire_on_close', 'session.encrypt',
        ...
        'solo.keybinding', 'solo.keybindings.default', 'solo.keybindings.vim', 'solo.commands.Vite', 'solo.commands.Queue',
        'solo.commands.Logs', 'solo.commands.Tests', 'solo.commands.Nightwatch', 'solo.use_screen', 'solo.dump_server_host',
        'ziggy.output.path', 'hashing.driver', 'hashing.bcrypt.rounds', 'hashing.bcrypt.verify', 'hashing.bcrypt.limit',
        ...
        'broadcasting.connections.null.driver', 'view.paths', 'view.compiled', 'debugbar.enabled', 'debugbar.hide_empty_tabs',
        ...
        'filament.file_generation.flags', 'filament.system_route_prefix', 'image.driver', 'image.options.autoOrientation', 'image.options.decodeAnimation',
        'image.options.blendingColor', 'image.options.strip', 'horizon.domain', 'horizon.path', 'horizon.use',
        ...
        'horizon.environments.production.supervisor-1.maxProcesses', 'horizon.environments.production.supervisor-1.balanceMaxShift', 'horizon.environments.production.supervisor-1.balanceCooldown', 'horizon.environments.local.supervisor-1.maxProcesses', 'nightwatch.enabled',
        ...
        'nightwatch.ingest.event_buffer', 'livewire.class_namespace', 'livewire.view_path', 'livewire.layout', 'livewire.lazy_placeholder',
        ...
        'livewire.navigate.show_progress_bar', 'livewire.navigate.progress_bar_color', 'livewire.inject_morph_markers', 'livewire.pagination_theme', 'media-library.disk_name',
    ...
    registerArgumentsSet('routes',
        ...
        'filament.admin.pages.dashboard', 'filament.admin.resources.authors.index', 'filament.admin.resources.authors.create', 'filament.admin.resources.authors.edit', 'filament.admin.resources.books.index',
        'filament.admin.resources.books.create', 'filament.admin.resources.books.edit', 'filament.admin.resources.covers.index', 'filament.admin.resources.covers.create', 'filament.admin.resources.covers.edit',
        'filament.admin.resources.notes.index', 'filament.admin.resources.notes.create', 'filament.admin.resources.notes.edit', 'filament.admin.resources.reviews.index', 'filament.admin.resources.reviews.create',
        'filament.admin.resources.reviews.edit', 'filament.admin.resources.users.index', 'filament.admin.resources.users.create', 'filament.admin.resources.users.edit', 'dusk.login',
        'dusk.logout', 'dusk.user', 'horizon.stats.index', 'horizon.workload.index', 'horizon.masters.index',
    ...
    registerArgumentsSet('views',
        'app', 'filament-actions::action-modal', 'filament-actions::components.group', 'filament-actions::components.modals', 'filament-forms::components.builder',
        ...
        'filament-schemas::components.text', 'filament-schemas::components.unordered-list', 'filament-schemas::components.wizard', 'filament-schemas::components.wizard.step', 'filament-tables::components.column-manager',
        'filament-tables::components.columns.layout', 'filament-tables::components.filters', 'filament-tables::components.search-field', 'filament-tables::components.summary.index', 'filament-tables::components.summary.row',
        ...
        'filament::components.icon', 'filament::components.icon-button', 'filament::components.input.checkbox', 'filament::components.input.index', 'filament::components.input.one-time-code',
        ...
        'filament::components.tabs.item', 'filament::components.toggle', 'horizon::layout', 'laravel-exceptions-renderer::components.card', 'laravel-exceptions-renderer::components.context',
    ...
    registerArgumentsSet('translations',
        ...
        'filament-forms::components.rich_editor.tools.attach_files', 'filament-forms::components.rich_editor.tools.blockquote', 'filament-forms::components.rich_editor.tools.bold', 'filament-forms::components.rich_editor.tools.bullet_list', 'filament-forms::components.rich_editor.tools.code_block',
        'filament-forms::components.rich_editor.tools.custom_blocks', 'filament-forms::components.rich_editor.tools.h1', 'filament-forms::components.rich_editor.tools.h2', 'filament-forms::components.rich_editor.tools.h3', 'filament-forms::components.rich_editor.tools.highlight',
        'filament-forms::components.rich_editor.tools.horizontal_rule', 'filament-forms::components.rich_editor.tools.italic', 'filament-forms::components.rich_editor.tools.lead', 'filament-forms::components.rich_editor.tools.link', 'filament-forms::components.rich_editor.tools.merge_tags',
        'filament-forms::components.rich_editor.tools.ordered_list', 'filament-forms::components.rich_editor.tools.redo', 'filament-forms::components.rich_editor.tools.small', 'filament-forms::components.rich_editor.tools.strike', 'filament-forms::components.rich_editor.tools.subscript',
        'filament-forms::components.rich_editor.tools.superscript', 'filament-forms::components.rich_editor.tools.table', 'filament-forms::components.rich_editor.tools.table_delete', 'filament-forms::components.rich_editor.tools.table_add_column_before', 'filament-forms::components.rich_editor.tools.table_add_column_after',
        'filament-forms::components.rich_editor.tools.table_delete_column', 'filament-forms::components.rich_editor.tools.table_add_row_before', 'filament-forms::components.rich_editor.tools.table_add_row_after', 'filament-forms::components.rich_editor.tools.table_delete_row', 'filament-forms::components.rich_editor.tools.table_merge_cells',
        'filament-forms::components.rich_editor.tools.table_split_cell', 'filament-forms::components.rich_editor.tools.table_toggle_header_row', 'filament-forms::components.rich_editor.tools.underline', 'filament-forms::components.rich_editor.tools.undo', 'filament-forms::components.select.actions.create_option.label',
        ...
        'filament-forms::components.text_input.actions.hide_password.label', 'filament-forms::components.text_input.actions.show_password.label', 'filament-forms::components.toggle_buttons.boolean.true', 'filament-forms::components.toggle_buttons.boolean.false', 'filament-forms::validation.distinct.must_be_selected',
        ...
        'filament-notifications::database.modal.empty.heading', 'filament-notifications::database.modal.empty.description', 'filament-schemas::components.wizard.actions.previous_step.label', 'filament-schemas::components.wizard.actions.next_step.label', 'filament::button.0',
        'filament::copyable.0', 'filament::modal.0', 'filament::pagination.0', 'filament-tables::query-builder.0', 'filament-tables::table.column_manager.heading',
        'filament-tables::table.column_manager.actions.apply.label', 'filament-tables::table.columns.actions.label', 'filament-tables::table.columns.text.actions.collapse_list', 'filament-tables::table.columns.text.actions.expand_list', 'filament-tables::table.columns.text.more_list_items',
        ...
        'filament-tables::table.actions.filter.label', 'filament-tables::table.actions.group.label', 'filament-tables::table.actions.open_bulk_actions.label', 'filament-tables::table.actions.column_manager.label', 'filament-tables::table.empty.heading',
    ...
    registerArgumentsSet('env',
        ...
        'APP_LOCALE', 'APP_FALLBACK_LOCALE', 'APP_FAKER_LOCALE', 'ISBNDB_API_KEY', 'APP_MAINTENANCE_DRIVER',
        'NIGHTWATCH_TOKEN', 'NIGHTWATCH_REQUEST_SAMPLE_RATE', 'NIGHTWATCH_IGNORE_CACHE_EVENTS', 'PHP_CLI_SERVER_WORKERS', 'BCRYPT_ROUNDS',
        'LOG_CHANNEL', 'LOG_STACK', 'LOG_DEPRECATIONS_CHANNEL', 'LOG_LEVEL', 'DB_CONNECTION',
        'DB_HOST', 'SESSION_DRIVER', 'SESSION_LIFETIME', 'SESSION_ENCRYPT', 'SESSION_PATH',
