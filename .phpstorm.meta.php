...
namespace PHPSTORM_META {
    ...
    registerArgumentsSet('configs',
        ...
        'filesystems.disks.s3.report', 'filesystems.links./Users/mason/Sites/library/public/storage', 'image-transform.public_path', 'image-transform.route_prefix', 'image-transform.enabled_options',
        ...
        'solo.commands.Logs', 'solo.use_screen', 'solo.dump_server_host', 'ziggy.output.path', 'hashing.driver',
        ...
        'filament.livewire_loading_delay', 'filament.file_generation.flags', 'filament.system_route_prefix', 'model_settings.settings_field_name', 'model_settings.settings_table_name',
        'model_settings.settings_persistent', 'model_settings.settings_table_use_cache', 'model_settings.settings_table_cache_prefix', 'model_settings.defaultSettings.users', 'image.driver',
        'image.options.autoOrientation', 'image.options.decodeAnimation', 'image.options.blendingColor', 'image.options.strip', 'horizon.domain',
        ...
        'horizon.environments.local.supervisor-1.maxProcesses', 'sanctum.stateful', 'sanctum.guard', 'sanctum.expiration', 'sanctum.token_prefix',
    ...
    registerArgumentsSet('routes',
        ...
        'filament.admin.resources.reviews.edit', 'filament.admin.resources.users.index', 'filament.admin.resources.users.create', 'filament.admin.resources.users.edit', 'horizon.stats.index',
        ...
        'livewire.upload-file', 'livewire.preview-file', 'image.transform',
        'books.cover.update', 'books.cover.destroy', 'books.index', 'books.show', 'books.api.search',
        'books.api.barcode', 'books.store', 'books.read.toggle', 'books.notes.store', 'books.reviews.store',
        'books.update', 'books.destroy', 'settings.profile.edit', 'settings.profile.update',
        'settings.profile.destroy', 'settings.password.edit', 'settings.password.update', 'settings.appearance', 'register', 'login', 'password.request', 'password.email',
